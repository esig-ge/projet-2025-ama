...
<div class="wrap">
    ...
    <table>
        ...
        <tbody>
        <tr>
            <td data-label="Nom">Mini Nounours </td>
        ...
        <tr>
            <td data-label="Nom">Déco anniv </td>
        ...
        <tr>
            <td data-label="Nom">papillons </td>
        ...
        <tr>
            <td data-label="Nom">batons coeur </td>
            <td data-label="ID">#14</td>
            <td data-label="Couleur">multicolore</td>
            <td data-label="Qté min">10</td>
            <td data-label="Qté max">200</td>
        ...
        <tr>
            <td data-label="Nom">paillettes </td>
            <td data-label="ID">#14</td>
            <td data-label="Couleur">multicolore</td>
            <td data-label="Qté min">10</td>
            <td data-label="Qté max">200</td>
